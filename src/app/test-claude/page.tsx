...
export default function TestClaudePage() {
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <h1 className="text-2xl font-bold text-center mb-8">Test Claude API Directly</h1>
      
      <div className="max-w-xl mx-auto bg-white p-6 rounded-lg shadow-md">
        <p className="mb-4 text-gray-700">
          Using Claude model: <code className="bg-gray-100 px-1 py-0.5 rounded">claude-3-7-sonnet-20250219</code>
        </p>
